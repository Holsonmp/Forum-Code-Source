...
<?php
			...
			$query->CloseCursor();
			//Et un petit message
			echo'<p>Votre message a bien été ajouté!<br /><br />Cliquez <a href="./voirtopic.php?t='.$nouveautopic.'">ici</a> pour le voir</p>';
		}break; //Houra !
?>
...
<?php
		...
		case "repondre":
			...
			else //Sinon, si le message n'est pas vide
			{
				...
				echo'<p>Votre message a bien été ajouté!<br /><br />Cliquez <a href="./voirtopic.php?t='.$topic.'&amp;page='.$page.'#p_'.$nouveaupost.'">ici</a> pour le voir</p>';
			}//Fin du else
			break;
		?>
