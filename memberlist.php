...
echo '<p><i>Vous êtes ici</i> : <a href="./index.php">Accueil</a> --><a href="./memberlist.php">Liste des membres</a></p>';
//Nombre de pages
...
//Requête
		...
		if ($query->rowCount() > 0)
		{
			...
			<?php
				...
				{
					echo '<tr><td><a href="./voirprofil.php?m='.$data['membre_id'].'&amp;action=consulter">'.stripslashes(htmlspecialchars($data['membre_pseudo'])).'</a></td>
...
{
echo'<p>Pour le moment il n\'ya aucun membre inscrit</p>';
}?>
